...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_rs-win2016_sql2017_rs-terraform0\shared-variables-ignore-soft.ps1
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0/shared-variables-ignore-soft.sh
...
docker run --rm -v ${pwd}:/workplace -w /workplace `
    ...
    -e ARM_SUBSCRIPTION_ID=$env:ARM_SUBSCRIPTION_ID `
    -e ARM_TENANT_ID=$env:ARM_TENANT_ID `
    -e MS_365_VMS_VM_SIZE=$env:MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_VM_SIZE `
    -e MS_365_VMS_IMAGE_NAME=$env:MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_NAME `
    -e MS_365_VMS_LOCATION=$env:MS_365_VMS_LOCATION `
    -e MS_365_VMS_IMAGE_RG_NAME=$env:MS_365_VMS_IMAGE_RG_NAME `
    -e MS_365_VMS_PACKER_VM_NAME=$($env:MS_365_VMS_VM_NAME_SPEC.Replace("%s",(Get-Date -Format "ddHHmmss"))) `
    hashicorp/packer:1.8.5 `
...
docker run --rm -v $(pwd):/workplace -w /workplace \
    ...
    -e ARM_SUBSCRIPTION_ID=$ARM_SUBSCRIPTION_ID \
    -e ARM_TENANT_ID=$ARM_TENANT_ID \
    -e MS_365_VMS_VM_SIZE=$MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_VM_SIZE \
...
$env:MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_ID = "/subscriptions/$env:ARM_SUBSCRIPTION_ID/resourceGroups/$env:MS_365_VMS_IMAGE_RG_NAME/providers/Microsoft.Compute/images/$env:MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_NAME"
cd c:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_rs-win2016_sql2017_rs-terraform0;
Remove-Item terraform.tfstate.d -Recurse
Start-Sleep 5;
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 init
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 workspace new $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 workspace select $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 apply -auto-approve `
    ...
    -var "MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_ID=$env:MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_ID" `
    -var "MS_365_VMS_WIN2016_SQL2017_RS_VM_SIZE=$env:MS_365_VMS_WIN2016_SQL2017_RS_VM_SIZE" `
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0/shared-variables-ignore-soft.sh
cd ~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0;
sudo rm -rf terraform.tfstate.d;
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 init
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 workspace new $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 workspace select $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 apply -auto-approve \
    ...
    -var "MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_ID=$MS_365_VMS_WIN2016_SQL2017_RS_IMAGE_ID" \
    -var "MS_365_VMS_WIN2016_SQL2017_RS_VM_SIZE=$MS_365_VMS_WIN2016_SQL2017_RS_VM_SIZE" \
...
```bash
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 taint -module=DB00 azurerm_virtual_machine.main
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_rs-win2016_sql2017_rs-terraform0 hashicorp/terraform:0.11.15 taint -module=AD00 azurerm_virtual_machine.main
```
