...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0\shared-variables-ignore-soft.ps1
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0/shared-variables-ignore-soft.sh
...
docker run --rm -v ${pwd}:/workplace -w /workplace `
    ...
    -e ARM_SUBSCRIPTION_ID=$env:ARM_SUBSCRIPTION_ID `
    -e ARM_TENANT_ID=$env:ARM_TENANT_ID `
    -e MS_365_VMS_VM_SIZE=$env:MS_365_VMS_WIN2019_SQL2019_IMAGE_VM_SIZE `
    -e MS_365_VMS_IMAGE_NAME=$env:MS_365_VMS_WIN2019_SQL2019_IMAGE_NAME `
    -e MS_365_VMS_LOCATION=$env:MS_365_VMS_LOCATION `
    -e MS_365_VMS_IMAGE_RG_NAME=$env:MS_365_VMS_IMAGE_RG_NAME `
    -e MS_365_VMS_PACKER_VM_NAME=$($env:MS_365_VMS_VM_NAME_SPEC.Replace("%s",(Get-Date -Format "ddHHmmss"))) `
    hashicorp/packer:light `
...
docker run --rm -v $(pwd):/workplace -w /workplace \
    ...
    -e ARM_SUBSCRIPTION_ID=$ARM_SUBSCRIPTION_ID \
    -e ARM_TENANT_ID=$ARM_TENANT_ID \
    -e MS_365_VMS_VM_SIZE=$MS_365_VMS_WIN2019_SQL2019_IMAGE_VM_SIZE \
    -e MS_365_VMS_IMAGE_NAME=$MS_365_VMS_WIN2019_SQL2019_IMAGE_NAME \
    -e MS_365_VMS_LOCATION=$MS_365_VMS_LOCATION \
    -e MS_365_VMS_IMAGE_RG_NAME=$MS_365_VMS_IMAGE_RG_NAME \
    -e MS_365_VMS_PACKER_VM_NAME=${MS_365_VMS_VM_NAME_SPEC//%s/$(date '+%d%H%M%S')} \
    hashicorp/packer:light \
...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0\shared-variables-ignore-soft.ps1
$env:MS_365_VMS_STACK_TYPE_ID = "win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-wp-tf0";
...
$env:MS_365_VMS_WIN2019_SQL2019_IMAGE_ID = "/subscriptions/$env:ARM_SUBSCRIPTION_ID/resourceGroups/$env:MS_365_VMS_IMAGE_RG_NAME/providers/Microsoft.Compute/images/$env:MS_365_VMS_WIN2019_SQL2019_IMAGE_NAME"
...
cd c:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0;
Remove-Item terraform.tfstate.d -Recurse
Start-Sleep 5;
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 init
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 workspace new $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 workspace select $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 apply -auto-approve `
    ...
    -var "MS_365_VMS_WIN2019_SQL2019_IMAGE_ID=$env:MS_365_VMS_WIN2019_SQL2019_IMAGE_ID" `
    -var "MS_365_VMS_WIN2019_SQL2019_VM_SIZE=$env:MS_365_VMS_WIN2019_SQL2019_VM_SIZE" `
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0/shared-variables-ignore-soft.sh
MS_365_VMS_STACK_TYPE_ID="win2022_ad_crm-win2019_sql2022-win2022_web-win2022_files-wp-tf0";
MS_365_VMS_STACK_INSTANCE_ID=$MS_365_VMS_PROJECT_PREFIX$MS_365_VMS_STACK_TYPE_ID"-dev01";
...
cd ~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0;
sudo rm -rf terraform.tfstate.d;
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 init
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 workspace new $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 workspace select $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 apply -auto-approve \
    ...
    -var "MS_365_VMS_WIN2019_SQL2019_IMAGE_ID=$MS_365_VMS_WIN2019_SQL2019_IMAGE_ID" \
    -var "MS_365_VMS_WIN2019_SQL2019_VM_SIZE=$MS_365_VMS_WIN2019_SQL2019_VM_SIZE" \
...
```bash
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2019_sql2019-win2022_web-win2022_files-win2022_wp-terraform0 hashicorp/terraform:0.11.15 taint -module=DB00 azurerm_virtual_machine.main
```
