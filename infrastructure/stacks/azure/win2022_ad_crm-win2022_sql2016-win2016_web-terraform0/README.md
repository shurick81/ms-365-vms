...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2022_sql2016-win2016_web-terraform0\shared-variables-ignore-soft.ps1
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0/shared-variables-ignore-soft.sh
...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2022_sql2016-win2016_web-terraform0\shared-variables-ignore-soft.ps1
$env:MS_365_VMS_STACK_TYPE_ID = "win2022_ad_crm-win2022_sql2016-win2016_web-terraform0";
...
cd c:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2022_sql2016-win2016_web-terraform0;
Remove-Item terraform.tfstate.d -Recurse
Start-Sleep 5;
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0 hashicorp/terraform:0.11.15 init
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0 hashicorp/terraform:0.11.15 workspace new $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0 hashicorp/terraform:0.11.15 workspace select $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0 hashicorp/terraform:0.11.15 apply -auto-approve `
    ...
    -var "MS_365_VMS_WIN2016_WEB_IMAGE_ID=$env:MS_365_VMS_WIN2022_SQL2016_IMAGE_ID" `
    -var "MS_365_VMS_WIN2016_WEB_VM_SIZE=$env:MS_365_VMS_WIN2022_AD_VM_SIZE" `
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0/shared-variables-ignore-soft.sh
MS_365_VMS_STACK_TYPE_ID="win2022_ad_crm-win2022_sql2016-win2016_web-terraform0";
MS_365_VMS_STACK_INSTANCE_ID=$MS_365_VMS_PROJECT_PREFIX$MS_365_VMS_STACK_TYPE_ID"-dev-11";
MS_365_VMS_DNS_PREFIX=$MS_365_VMS_PROJECT_PREFIX"dev-11-";
...
cd ~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0;
sudo rm -rf terraform.tfstate.d;
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0 hashicorp/terraform:0.11.15 init
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0 hashicorp/terraform:0.11.15 workspace new $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0 hashicorp/terraform:0.11.15 workspace select $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web-terraform0 hashicorp/terraform:0.11.15 apply -auto-approve \
