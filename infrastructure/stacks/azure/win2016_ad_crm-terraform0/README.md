...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2016_ad_crm-terraform0\shared-variables-ignore-soft.ps1
...
docker run --rm -v ${pwd}:/workplace -w /workplace `
    ...
    -e MS_365_VMS_VM_SIZE=$env:MS_365_VMS_WIN2016_AD_IMAGE_VM_SIZE `
    -e MS_365_VMS_IMAGE_NAME=$env:MS_365_VMS_WIN2016_AD_IMAGE_NAME `
    ...
    build -only azure-arm win2016-ad.json
```

```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2016_ad_crm-terraform0/shared-variables-ignore-soft.sh
...
docker run --rm -v $(pwd):/workplace -w /workplace \
    ...
    -e MS_365_VMS_VM_SIZE=$MS_365_VMS_WIN2016_AD_IMAGE_VM_SIZE \
    -e MS_365_VMS_IMAGE_NAME=$MS_365_VMS_WIN2016_AD_IMAGE_NAME \
...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2016_ad_crm-terraform0\shared-variables-ignore-soft.ps1
$env:MS_365_VMS_STACK_TYPE_ID = "win2016_ad_crm-terraform0";
$env:MS_365_VMS_STACK_INSTANCE_ID = $env:MS_365_VMS_PROJECT_PREFIX + $env:MS_365_VMS_STACK_TYPE_ID + "-dev-00";
$env:MS_365_VMS_WIN2016_AD_IMAGE_ID = "/subscriptions/$env:ARM_SUBSCRIPTION_ID/resourceGroups/$env:MS_365_VMS_IMAGE_RG_NAME/providers/Microsoft.Compute/images/$env:MS_365_VMS_WIN2016_AD_IMAGE_NAME"
cd c:\projects\ms-365-vms\infrastructure\stacks\azure\win2016_ad_crm-terraform0;
Remove-Item terraform.tfstate.d -Recurse
Start-Sleep 5;
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2016_ad_crm-terraform0 hashicorp/terraform:0.11.15 init
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2016_ad_crm-terraform0 hashicorp/terraform:0.11.15 workspace new $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2016_ad_crm-terraform0 hashicorp/terraform:0.11.15 workspace select $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2016_ad_crm-terraform0 hashicorp/terraform:0.11.15 apply -auto-approve `
    ...
    -var "MS_365_VMS_WIN2016_AD_IMAGE_ID=$env:MS_365_VMS_WIN2016_AD_IMAGE_ID" `
    -var "MS_365_VMS_WIN2016_AD_VM_SIZE=$env:MS_365_VMS_WIN2016_AD_VM_SIZE" `
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2016_ad_crm-terraform0/shared-variables-ignore-soft.sh
MS_365_VMS_STACK_TYPE_ID="win2016_ad_crm-terraform0";
MS_365_VMS_STACK_INSTANCE_ID=$MS_365_VMS_PROJECT_PREFIX$MS_365_VMS_STACK_TYPE_ID"-dev-00";
MS_365_VMS_WIN2016_AD_IMAGE_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/$MS_365_VMS_IMAGE_RG_NAME/providers/Microsoft.Compute/images/$MS_365_VMS_WIN2016_AD_IMAGE_NAME"
cd ~/projects/ms-365-vms/infrastructure/stacks/azure/win2016_ad_crm-terraform0;
sudo rm -rf terraform.tfstate.d;
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2016_ad_crm-terraform0 hashicorp/terraform:0.11.15 init
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2016_ad_crm-terraform0 hashicorp/terraform:0.11.15 workspace new $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2016_ad_crm-terraform0 hashicorp/terraform:0.11.15 workspace select $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2016_ad_crm-terraform0 hashicorp/terraform:0.11.15 apply -auto-approve \
    ...
    -var "MS_365_VMS_WIN2016_AD_IMAGE_ID=$MS_365_VMS_WIN2016_AD_IMAGE_ID" \
    -var "MS_365_VMS_WIN2016_AD_VM_SIZE=$MS_365_VMS_WIN2016_AD_VM_SIZE" \
