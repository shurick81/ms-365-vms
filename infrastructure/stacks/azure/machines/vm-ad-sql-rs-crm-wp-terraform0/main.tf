...
resource "azurerm_virtual_machine" "main" {
  ...
  provisioner "remote-exec" {
    ...
    inline     = [
      "powershell.exe -command \"Stop-Service SQLServerReportingServices; Stop-Service W3SVC\""
    ]
  }
  ...
  provisioner "remote-exec" {
    ...
    inline     = [
      "powershell.exe -command \"Start-Service SQLServerReportingServices; Start-Service W3SVC\""
    ]
  }
  ...
  provisioner "file" {
    ...
    source      = "./../../customizations/rs/rsconfig.ps1"
    destination = ".\\common\\rsconfig.ps1"
  }
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      "powershell.exe -command \"$env:MS_365_VMS_DOMAIN_NAME = '${var.ms_365_vms_domain_name}'; $env:INSTALL_USERNAME = '${var.ms_365_vms_domain_name}\\_crmadmin'; $env:INSTALL_PASSWORD = '${var.install_password}'; $env:RS_SERVICE_PASSWORD = '${var.rs_service_password}'; $rsDatabaseInstance = '${var.database_instance}'; .\\common\\rsconfig.ps1\"",
    ]
  }
  ...
  provisioner "remote-exec" {
    ...
    inline     = [
      "powershell.exe -command \"$env:USERNAME = '${var.ms_365_vms_domain_name}\\_crmadmin'; $env:PASSWORD = '${var.install_password}'; $env:HOST_NAME = '${var.vm_domain_name_label}.${var.location}.cloudapp.azure.com'; .\\common\\local-site.ps1\""
    ]
  }
