...
# Active directory domain with SQL RS prerequisites
...
resource "azurerm_virtual_machine" "main" {
  ...
  provisioner "file" {
    ...
    source      = "./../../customizations/rs/rsdomaincustomizations.ps1"
    destination = ".\\common\\rsdomaincustomizations.ps1"
  }
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      "powershell.exe -command \"$env:MS_365_VMS_DOMAIN_NAME = '${var.ms_365_vms_domain_name}'; $env:INSTALL_PASSWORD = '${var.install_password}'; $env:RS_SERVICE_PASSWORD = '${var.rs_service_password}'; .\\common\\rsdomaincustomizations.ps1\"",
    ]
  }
