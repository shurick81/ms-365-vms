...
resource "azurerm_virtual_machine" "main" {
  ...
  provisioner "file" {
    ...
    source      = "./../../Add-ComputerToDomain.ps1"
    destination = ".\\common\\Add-ComputerToDomain.ps1"
  }
  ...
  provisioner "remote-exec" {
    ...
    inline     = [
      "powershell.exe -command \"$env:MS_365_VMS_DOMAIN_NAME = '${var.ms_365_vms_domain_name}'; $env:VM_ADMIN_USERNAME = '${var.vm_admin_username}'; $env:MS_365_VMS_DOMAIN_ADMIN_PASSWORD = '${var.domain_admin_password}'; .\\common\\Add-ComputerToDomain.ps1; shutdown /r /f /t 5 /c 'forced reboot'; net stop WinRM\""
    ]
    on_failure = "continue"
  }
  ...
  provisioner "file" {
    ...
    source      = "./../../Add-DomainClientGroupMembers.ps1"
    destination = ".\\common\\Add-DomainClientGroupMembers.ps1"
  }
  ...
  provisioner "remote-exec" {
    ...
    inline     = [
      "powershell.exe -command \"$env:MS_365_VMS_DOMAIN_NAME = '${var.ms_365_vms_domain_name}'; $env:VM_ADMIN_USERNAME = '${var.vm_admin_username}'; $env:MS_365_VMS_DOMAIN_ADMIN_PASSWORD = '${var.domain_admin_password}'; $MembersToInclude = '${var.local_admins}'; .\\common\\Add-DomainClientGroupMembers.ps1;\""
    ]
    on_failure = "continue"
  }
