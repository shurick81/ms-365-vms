...
variable "MS_365_VMS_WIN2022_SQL2022_IMAGE_ID" {}
variable "MS_365_VMS_WIN2022_SQL2022_VM_SIZE" {}
variable "MS_365_VMS_WIN2022_RS2022_IMAGE_ID" {}
variable "MS_365_VMS_WIN2022_RS2022_VM_SIZE" {}
...
module "DB00" {
  ...
  vm_resource_group_name              = "${azurerm_resource_group.environment.name}"
  main_subnet_id                      = "${azurerm_subnet.mainterraformsubnet.id}"
  image_id                            = "${var.MS_365_VMS_WIN2022_SQL2022_IMAGE_ID}"
  vm_name                             = "${format(var.MS_365_VMS_VM_NAME_SPEC, "db00")}"
  vm_size                             = "${var.MS_365_VMS_WIN2022_SQL2022_VM_SIZE}"
  ms_365_vms_domain_name              = "${var.MS_365_VMS_DOMAIN_NAME}"
  local_admins                        = "${var.MS_365_VMS_DOMAIN_NAME}\\_install"
  dependencies = [
...
module "DB01" {
  source                              = "./../machines/vm-rs-terraform0"
  environmentId                       = "${terraform.workspace}"
  location                            = "${var.MS_365_VMS_LOCATION}"
  vm_admin_username                   = "${var.VM_ADMIN_USERNAME}"
  vm_admin_password                   = "${var.MS_365_VMS_VM_ADMIN_PASSWORD}"
  ...
  vm_resource_group_name              = "${azurerm_resource_group.environment.name}"
  main_subnet_id                      = "${azurerm_subnet.mainterraformsubnet.id}"
  image_id                            = "${var.MS_365_VMS_WIN2022_RS2022_IMAGE_ID}"
  vm_name                             = "${format(var.MS_365_VMS_VM_NAME_SPEC, "db01")}"
  vm_size                             = "${var.MS_365_VMS_WIN2022_RS2022_VM_SIZE}"
  ms_365_vms_domain_name              = "${var.MS_365_VMS_DOMAIN_NAME}"
  local_admins                        = "${var.MS_365_VMS_DOMAIN_NAME}\\_install,${var.MS_365_VMS_DOMAIN_NAME}\\_ssrs"
  dependencies = [
