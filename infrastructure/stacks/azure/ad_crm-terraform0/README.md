...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\ad_crm-terraform0\shared-variables-ignore-soft.ps1
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/ad_crm-terraform0/shared-variables-ignore-soft.sh
...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\ad_crm-terraform0\shared-variables-ignore-soft.ps1
$env:MS_365_VMS_STACK_TYPE_ID = "ad_crm-terraform0";
...
cd c:\projects\ms-365-vms\infrastructure\stacks\azure\ad_crm-terraform0;
Remove-Item terraform.tfstate.d -Recurse
Start-Sleep 5;
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/ad_crm-terraform0 hashicorp/terraform:1.3.7 init
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/ad_crm-terraform0 hashicorp/terraform:1.3.7 workspace new $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/ad_crm-terraform0 hashicorp/terraform:1.3.7 workspace select $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/ad_crm-terraform0 hashicorp/terraform:1.3.7 apply -auto-approve `
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/ad_crm-terraform0/shared-variables-ignore-soft.sh
MS_365_VMS_STACK_TYPE_ID="ad_crm-terraform0";
...
cd ~/projects/ms-365-vms/infrastructure/stacks/azure/ad_crm-terraform0;
sudo rm -rf terraform.tfstate.d;
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/ad_crm-terraform0 hashicorp/terraform:1.3.7 init
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/ad_crm-terraform0 hashicorp/terraform:1.3.7 workspace new $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/ad_crm-terraform0 hashicorp/terraform:1.3.7 workspace select $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/ad_crm-terraform0 hashicorp/terraform:1.3.7 apply -auto-approve \
