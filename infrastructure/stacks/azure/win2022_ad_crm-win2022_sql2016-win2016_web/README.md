...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2022_sql2016-win2016_web\shared-variables-ignore-soft.ps1
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web/shared-variables-ignore-soft.sh
...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2022_sql2016-win2016_web\shared-variables-ignore-soft.ps1
$env:MS_365_VMS_STACK_TYPE_ID = "win2022_ad_crm-win2022_sql2016-win2016_web";
...
cd c:\projects\ms-365-vms\infrastructure\stacks\azure\win2022_ad_crm-win2022_sql2016-win2016_web;
Remove-Item terraform.tfstate.d -Recurse
Start-Sleep 5;
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web hashicorp/terraform:1.3.7 init
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web hashicorp/terraform:1.3.7 workspace new $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web hashicorp/terraform:1.3.7 workspace select $env:MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v ${pwd}/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web hashicorp/terraform:1.3.7 apply -auto-approve `
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web/shared-variables-ignore-soft.sh
MS_365_VMS_STACK_TYPE_ID="win2022_ad_crm-win2022_sql2016-win2016_web";
MS_365_VMS_STACK_INSTANCE_ID=$MS_365_VMS_PROJECT_PREFIX$MS_365_VMS_STACK_TYPE_ID"-dev-01";
MS_365_VMS_DNS_PREFIX=$MS_365_VMS_PROJECT_PREFIX"test-00-";
...
cd ~/projects/ms-365-vms/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web;
sudo rm -rf terraform.tfstate.d;
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web hashicorp/terraform:1.3.7 init
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web hashicorp/terraform:1.3.7 workspace new $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web hashicorp/terraform:1.3.7 workspace select $MS_365_VMS_STACK_INSTANCE_ID
docker run --rm -v $(pwd)/../../../..:/workplace -w /workplace/infrastructure/stacks/azure/win2022_ad_crm-win2022_sql2016-win2016_web hashicorp/terraform:1.3.7 apply -auto-approve \
