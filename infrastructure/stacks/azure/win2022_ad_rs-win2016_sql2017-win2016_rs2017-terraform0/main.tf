...
variable "MS_365_VMS_WIN2016_SQL2017_IMAGE_ID" {}
variable "MS_365_VMS_WIN2016_SQL2017_VM_SIZE" {}
variable "MS_365_VMS_WIN2016_RS2017_IMAGE_ID" {}
variable "MS_365_VMS_WIN2016_RS2017_VM_SIZE" {}
...
module "DB00" {
  ...
  vm_resource_group_name              = "${azurerm_resource_group.environment.name}"
  main_subnet_id                      = "${azurerm_subnet.mainterraformsubnet.id}"
  image_id                            = "${var.MS_365_VMS_WIN2016_SQL2017_IMAGE_ID}"
  vm_name                             = "${format(var.MS_365_VMS_VM_NAME_SPEC, "db00")}"
  vm_size                             = "${var.MS_365_VMS_WIN2016_SQL2017_VM_SIZE}"
  ms_365_vms_domain_name              = "${var.MS_365_VMS_DOMAIN_NAME}"
...
module "DB01" {
  ...
  vm_resource_group_name              = "${azurerm_resource_group.environment.name}"
  main_subnet_id                      = "${azurerm_subnet.mainterraformsubnet.id}"
  image_id                            = "${var.MS_365_VMS_WIN2016_RS2017_IMAGE_ID}"
  vm_name                             = "${format(var.MS_365_VMS_VM_NAME_SPEC, "db01")}"
  vm_size                             = "${var.MS_365_VMS_WIN2016_RS2017_VM_SIZE}"
  ms_365_vms_domain_name              = "${var.MS_365_VMS_DOMAIN_NAME}"
