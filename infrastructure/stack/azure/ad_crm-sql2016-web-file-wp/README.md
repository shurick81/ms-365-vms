...
```PowerShell
C:\projects\ms-365-vms\infrastructure\stacks\azure\ad_crm-sql2016-web-file-wp\shared-variables.ps1
...
```bash
~/projects/ms-365-vms/infrastructure/stacks/azure/ad_crm-sql2016-web-file-wp/shared-variables.sh
